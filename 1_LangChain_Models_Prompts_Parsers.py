...
# llm_model = ChatOpenAI(temperature=0, model = "gpt-3.5-turbo-0301", engine = "gpt-3.5-turbo-0301")
...
#Langchain
chat = ChatOpenAI(temperature=0, model="gpt-3.5-turbo-16k",engine = "gpt-35-turbo-16k")
chat
